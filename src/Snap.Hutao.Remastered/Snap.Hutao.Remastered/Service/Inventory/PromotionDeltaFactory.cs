...
using CalculableAvatar = Snap.Hutao.Remastered.Web.Hoyolab.Takumi.Event.Calculate.Avatar;
using CalculableWeapon = Snap.Hutao.Remastered.Web.Hoyolab.Takumi.Event.Calculate.Weapon;
...
public sealed partial class PromotionDeltaFactory
{
