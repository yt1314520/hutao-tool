...
using CalculateConsumption = Snap.Hutao.Remastered.Web.Hoyolab.Takumi.Event.Calculate.Consumption;
...
using static Snap.Hutao.Remastered.Service.Cultivation.Offline.Lookups;
