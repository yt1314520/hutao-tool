...
public sealed partial class LegacyMetadataService : IMetadataService
{
    ...
    private readonly LegacyMetadataOptions metadataOptions;
    ...
    public partial LegacyMetadataService(IServiceProvider serviceProvider);
...
#pragma warning restore CA2024
    ...
    private sealed class MetadataDownloadContext
    {
        ...
        public MetadataDownloadContext(LegacyMetadataOptions options, MetadataTemplate? template)
        {
            Options = options;
            Template = template;
        }

        public LegacyMetadataOptions Options { get; }
