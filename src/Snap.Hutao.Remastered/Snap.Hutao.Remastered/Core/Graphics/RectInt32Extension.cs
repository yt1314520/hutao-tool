...
public static class RectInt32Extension
{
    ...
    {
        public int Size { get => rectInt32.Width * rectInt32.Height; }

        public unsafe SizeInt32 SizeInt32 { get => ((RectInt32View*)&rectInt32)->Size; }

        public RectInt32 Scale(double scale)
        {
            return new((int)(rectInt32.X * scale), (int)(rectInt32.Y * scale), (int)(rectInt32.Width * scale), (int)(rectInt32.Height * scale));
        }

        public unsafe PointInt32 GetPointInt32(PointInt32Kind kind)
        {
        ...
        public RECT ToRECT()
        {
            return new(rectInt32.X, rectInt32.Y, rectInt32.X + rectInt32.Width, rectInt32.Y + rectInt32.Height);
        }
    }
}