...
namespace Snap.Hutao.Remastered.Test.IncomingFeature;
...
public partial class UnUsedResourceStringTest
{
    ...
    public void GetAllUnUsedResourceStrings()
    {
        ...
        string resxPath = Path.Combine(path, @"Snap.Hutao.Remastered\Resource\Localization\SH.resx");
        ...
        foreach (ref string file in Directory.GetFiles(path,"*", SearchOption.AllDirectories).AsSpan())
        {
            ...
            if (file.Contains("Snap.Hutao.Remastered.Test", StringComparison.OrdinalIgnoreCase) ||
                file.Contains("Snap.Hutao.Remastered\\obj", StringComparison.OrdinalIgnoreCase) ||
                file.Contains("Snap.Hutao.Remastered\\bin", StringComparison.OrdinalIgnoreCase))
            {
                continue;
            }
